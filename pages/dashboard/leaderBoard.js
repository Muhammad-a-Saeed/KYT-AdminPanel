          ...
          return (
            <div className="flex items-center text-secondary text-sm gap-2">
              <img
                ...
                alt={row.original.email ? `${row.original.email}'s Profile` : "Profile"} // Alt text with user email fallback
                style={{
                  width: 50,
                  height: 50,
                  objectFit: "cover",
    ...
    >
      ...
      <div>
        <div className="flex text-[#4D515A] text-sm font-medium">
          Dashboard <Dashboard_Chevron /> Leader Board <Dashboard_Chevron />
        </div>
        <h1 className="text-2xl text-secondary font-bold my-3">Leader Board</h1>
